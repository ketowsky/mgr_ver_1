...
\thispagestyle{empty}
%% ------------------------ NAGLOWEK STRONY ------------------------------
\includegraphics[height=37.5mm]{logAGH.jpg}\\
\rule{30mm}{0pt}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=1\textwidth]{ID3_algorithm_decision_tree.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{SVN.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{KDE.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=1\textwidth]{pnn.png}
...
\begin{table}[h!]
  ...
  \begin{tabular}{ | c | m{6cm} | m{3cm} | }
    ...
    \begin{minipage}[c][7cm]{.4\textwidth}
      \includegraphics[width=\linewidth, height=60mm]{uniform}
    \end{minipage}
    &
     $ K(x)=1/2, |x|\leq1$
    & 
    ...
    \\ \hline
    \begin{minipage}[c][7cm]{.4\textwidth}
      \includegraphics[width=\linewidth, height=60mm]{triangular}
    \end{minipage}
    &
     $ K(x)=(1-|x|), |x|\leq1$
    & 
    ...
    \\ \hline
    \begin{minipage}[c][7cm]{.4\textwidth}
      \includegraphics[width=\linewidth, height=60mm]{epanechnikov}
    \end{minipage}
    &
...
\begin{table}[h!]
  ...
  \begin{tabular}{ | c | m{6cm} | m{3cm} | }
    ...
    Wykres & Wzór & Nazwa \\ \hline
    \begin{minipage}[c][7cm]{.4\textwidth}
      \includegraphics[width=\linewidth, height=60mm]{biweight}
    \end{minipage}
    &
    ...
    \\ \hline
    \begin{minipage}[c][7cm]{.4\textwidth}
      \includegraphics[width=\linewidth, height=60mm]{gausian}
    \end{minipage}
    &
    ...
    \\ \hline
    \begin{minipage}[c][7cm]{.4\textwidth}
      \includegraphics[width=\linewidth, height=60mm]{cauchy}
    \end{minipage}
    &
     $ K(x)=2/\pi(x^2+1)^2 $
    & 
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\textwidth]{R_logo.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=1\textwidth]{plotPNN}
...
\begin{figure}
    \centering
    \includegraphics[width=1.2\textwidth]{sm4}
